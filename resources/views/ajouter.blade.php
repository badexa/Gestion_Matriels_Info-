...
<html lang="en">
  ...
  <body>
      ...
      <div class="container">
            <div class="row">
                <div class="col s12">
              <center> <h1 style="font-size: 80px;text-shadow: 1px 1px 2px black, 0 0 25px red">AJOUTER UN MATERIEL</h1>   </center>
...
<div class="container mt-5">
  ...
  <input name="Qu" type="number" class="form-control" id="exampleFormControlInput1" placeholder="Veuillez Saisir La Quantitée" style="height: 40%;">
</div>
<div class="form-group col-md-6" >
  <label style="color:azure;font-size: 60px;text-shadow: 1px 1px 2px black, 0 0 25px blue" for="Inv">Inventaire</label>
  <input name="Inv" type="number" class="form-control" id="exampleFormControlInput1" placeholder="Veuillez Saisir l'inventaire"  style="height: 40%;">
</div>
   <div class="form-group col-md-6">
  <label style="color:azure;font-size: 60px;text-shadow: 1px 1px 2px black, 0 0 25px blue" for="Date">Date</label>
  <input name="Date" type="Date" class="form-control" id="exampleFormControlInput1" placeholder="La Date"  style="height: 40%;">
</div>
<div class="form-group col-md-6">
  <label style="color:azure;font-size: 60px;text-shadow: 1px 1px 2px black, 0 0 25px blue" for="Marque">Marque</label>
  <input name="Marque" type="text" class="form-control" id="exampleFormControlInput1" placeholder="Veuillez Saisir La Marque"  style="height: 40%;">
</div>
<div class="form-group col-md-6" >
  <label style="color:azure;font-size: 60px;text-shadow: 1px 1px 2px black, 0 0 25px blue" for="Modéle">Modéle</label>
  <input name="Modéle" type="text" class="form-control" id="exampleFormControlInput1" placeholder="Veuillez Saisir le modéle"  style="height: 40%;">
</div>
<div class="form-group col-md-6">
  <label style="color:azure;font-size: 60px;text-shadow: 1px 1px 2px black, 0 0 25px blue" for="Processeur">Processeur</label>
  <input name="Processeur" type="text" class="form-control" id="exampleFormControlInput1" placeholder="Veuillez Saisir le Processeur"  style="height: 40%;">
</div>
<div class="form-group col-md-6">
  <label style="color:azure;font-size: 60px;text-shadow: 1px 1px 2px black, 0 0 25px blue" for="Vitesse">Vitesse</label>
  <input name="Vitesse" type="text" class="form-control" id="exampleFormControlInput1" placeholder="Veuillez Saisir la Vitesse"  style="height: 40%;">
</div>
<div class="form-group col-md-6">
  <label style="color:azure;font-size: 60px;text-shadow: 1px 1px 2px black, 0 0 25px blue" for="Ram">Ram</label>
  <input name="Ram" type="text" class="form-control" id="exampleFormControlInput1" placeholder="Veuillez Saisir la capacité de ram"  style="height: 40%;">
</div>
<div class="form-group col-md-6">
  <label style="color:azure;font-size: 60px;text-shadow: 1px 1px 2px black, 0 0 25px blue" for="Format">Format</label>
  <input name="Format" type="text" class="form-control" id="exampleFormControlInput1" placeholder="Veuillez Saisir le format"  style="height: 40%;">
</div>
<div class="form-group col-md-6">
  <label style="color:azure;font-size: 60px;text-shadow: 1px 1px 2px black, 0 0 25px blue" for="Programme">Programme</label>
  <input name="Programme" type="text" class="form-control" id="exampleFormControlInput1" placeholder="Veuillez Saisir le programme"  style="height: 40%;">
</div>
<div class="form-group col-md-6">
  <label style="color:azure;font-size: 60px;text-shadow: 1px 1px 2px black, 0 0 25px blue" for="Projet">Projet</label>
  <input name="Projet" type="text" class="form-control" id="exampleFormControlInput1" placeholder="Veuillez Saisir le projet"  style="height: 40%;">
</div>
...
<div class="form-group  col-md-6">
    ...
    <div class="form-group  col-md-6">
    <label style="color:azure;font-size: 60px;text-shadow: 1px 1px 2px black, 0 0 25px blue" for="etablissement" class="form-label">Etablissement</label>
...
<hr>
<center><button type="submit" class="btn btn-primary" style="width: 20%;">AJOUTER</button>
